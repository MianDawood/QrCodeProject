<div class="row align-items-center">
    ...
    <div class="col-lg-3 px-1">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="input input-checkbox d-flex align-items-center justify-content-center">
                <input type="color" class="gradiantEyeColorOne">
                <label class="gradiantEyeColorOne-label px-4"></label>
            </div>
            </div>
        </div>
        </div>
    </div>
    <div @click="swapColors('eyeColor')" class="col-lg-1 d-flex justify-content-center">
    ...
    <div class="col-lg-3 px-1">          
        ...
        <div class="d-flex align-items-center">
            <div class="form-group my-3 m-0 d-flex flex-column align-items-center justify-content-center flex-wrap">
            <div class="input input-checkbox d-flex align-items-center justify-content-center">
                <input type="color" class="gradiantEyeColorTwo">
                <label class="gradiantEyeColorTwo-label px-4"></label>
            </div>
            </div>
        </div>
        </div>
    ...
    <div class="col-lg-3">
        ...
        <select @change="updatevCardQrCode" v-model="qrCodeState.dotEyeColorGradiantType" class="downloadFormat">

                  ...
                  <form class="qrForm">
                    <div class="row align-items-center">
                      ...
                      <div class="col-lg-5">
                        <div class="form-group my-3 m-0 d-flex flex-column align-items-center justify-content-center">
                          <div class="input">
                            <input type="text" class="form-control" id="land-line" aria-describedby="emailHelp"
                      ...
                      <div class="col-lg-5">
                        <div class="form-group my-3 m-0 d-flex flex-column align-items-center justify-content-center">
                          <div class="input">
                            <input type="text" class="form-control" id="role" aria-describedby="emailHelp" placeholder="Your Job Title">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-5">
                        <div class="form-group my-3 m-0 d-flex flex-column align-items-center justify-content-center">
                          <div class="input">
                            <input type="text" class="form-control" id="zipcode" aria-describedby="emailHelp" placeholder="Zipcode">
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-2 d-none d-lg-block">
                      ...
                      <div class="col-lg-5">
                        <div class="form-group my-3 m-0 d-flex flex-column align-items-center justify-content-center">
                          <div class="input">
                            <input type="text" class="form-control" id="street" aria-describedby="emailHelp" placeholder="Street">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-10">
                        <div class="form-group my-3 m-0 d-flex flex-column align-items-center justify-content-center">
                          <div class="input">
                            <textarea name="summery" placeholder="A brief description about you and your skills" class="form-control" id="summery" cols="30" rows="10"></textarea>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="px-4 text-center py-2 my-3">
                      <button type="button" class="btn btn-outline-dark py-3 px-4" style="border-radius: 20px;">Generate
                        VCard</button>
                    </div>
                  </form>
                </div>
                        ...
                        <div class="row logo-bg">
                          ...
                          for ($i=1; $i <= 10; $i++) { ?>
                            ...
                            <div class='col-lg-3 col-md-4 col-sm-6 p-2'>
                              <div class='logo-bg-item logo-bg-item-<?php echo $i ?>'>
                                <img src='./assets/images/qr-logo/<?php echo $i ?>.png' alt='' class=' logo-img'>
                              </div>
                            </div>
                          <?php
                          }

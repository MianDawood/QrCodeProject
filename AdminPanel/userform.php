    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
          <a href="usertable.php" class="nav nav-link text text-light"><button class="btn btn-primary"><i class="fas fa-eye"> View Record</i></button></a>
          </div>
          <!-- <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="User/insertion.php" method="post">
                <div class="card-body">

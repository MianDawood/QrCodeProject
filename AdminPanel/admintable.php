...
{
  $search = $_GET['search'];
  $SqlQuery = "SELECT * FROM admin where adminName like '%$search%' or adminAddress like '%$search%' ";
              ...
              <div class="card-header">
                  ...
                  else
                  {
                    ...
                    ?>
                      ...
                      <a href="adminform.php"><button class="btn btn-primary"><i class="fas fa-plus"> Add</i></button></a>
                      </div>
                      <div class="col-2 col-sm-2 col-md-2 col-lg-2">
                      <a href="Admin/deleteall.php"><button class="btn btn-danger" onclick="return confirm('are you sure want to delete all record')"><i class="fas fa-trash"> DeleteAll</i></button></a>
                      </div>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $a; ?></td>
                      <td><?php echo $display['adminName']; ?></td>
                      <td><?php echo $display['adminEmail']; ?></td>
                      <td><?php echo $display['adminPassword']; ?></td>
                      <td><?php echo $display['adminAddress']; ?></td>
                      <td>  
                        <a href="Admin/delete.php?Aid=<?php echo $display['adminId'] ?>"><button class="btn btn-danger"><i class="fas fa-trash"></i></button></a>
                        <a href="adminedit.php?Aid=<?php echo $display['adminId'] ?>"><button class="btn btn-info"><i class="fas fa-edit"></i></button></a>
                      </td>
                    </tr>
                    <?php $a++; }  ?>
                  </tbody>

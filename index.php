...
<body>
    ...
    <div class="banner_bg">
      <div class="row banner_row">
        <div class="col-lg-6 col-md-6 col-sm-12 banner">
          ...
          <p class="text-left"> Do-It-Yourself QR Codes to Promote Your Business </p> <button class="btn btn-dark"
            type="button">Create your QR Code<i class="fas fa-arrow-right"></i></button>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 my-life-col">
          <div class="my_life_text">
            <h3>My life is like a QR code. Only those who have a spiritual connect with reading can scan it to find my
              real self</h3>
          </div>
        </div>
      </div>
  ...
  <section class="container btns-container">
    ...
    <div class="row btn-row">
      <div class="col-lg-12 col-md-12 col-sm-12 btns">
        <div class="row ">
          <div class="col-lg-12 col-md-12 col-sm-12  menu"> <button id="menu" class="btn btn-dark" type="button">
              ...
              <div class="svg"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80">
                  ...
                  <path d="M39.5,30.64a3,3,0,1,0,3,3A3,3,0,0,0,39.5,30.64Zm0,5a2,2,0,1,1,2-2A2,2,0,0,1,39.5,35.64Z">
                  </path>
                  <path
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 ">
            <div class="center-btns">
              ...
              <div class="center-img"> <img src="assets/images/center.png" class="img-fluid" alt=""> </div>
              <div class="right-btn"> <button id="wifi" class="btn btn-dark" type="button">
                  <div class="svg"> <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                      ...
                      <path d="M39.5,37.85a2.57,2.57,0,1,0,2.57,2.57A2.57,2.57,0,0,0,39.5,37.85Z"></path>
                      <path
                  ...
                  <div class="svg"> <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                      ...
                      <path d="M35,59.62H49a.5.5,0,0,0,.5-.5.5.5,0,0,0-.5-.5H35a.5.5,0,0,0-.5.5A.5.5,0,0,0,35,59.62Z">
                      </path>
                      <path
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 bottom-btn"> <button id="pdf" class="btn btn-dark" type="button">
              <div class="svg"> <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 80 80">
                  <defs>
                    <style>
                  ...
                  <path class="cls-1" d="M46.5,16.5h-20a4,4,0,0,0-4,4v39a4,4,0,0,0,4,4h27a4,4,0,0,0,4-4v-32Z"></path>
                  <path
    ...
    <section class="container">
      <div class="row ">
        <div class="col-12 p-0">
          <div class="heading text-center ">
            <h2> Your subscription to QR Code Service is your doorway to infinite business possibilities. </h2>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 order-md-1 left_box">
          <div class="left_inside">
            <div class="icon"> <img src="assets/images/click.png" alt="" class="img-fluid"> <span>Unique, dynamic QR code
                design.</span> </div>
            <div class="icon"> <img src="assets/images/click.png" alt="" class="img-fluid"> <span>Simple editing and management
                tools.</span> </div>
            <div class="icon"> <img src="assets/images/click.png" alt="" class="img-fluid"> <span>Unlimited scans.</span>
            </div>
            <div class="icon"> <img src="assets/images/click.png" alt="" class="img-fluid"> <span>Variety of download
                formats.</span> </div>
            <div class="icon"> <img src="assets/images/click.png" alt="" class="img-fluid"> <span>Complete QR Code analytics
                provided.</span> </div>
            <div class="icon"> <img src="assets/images/click.png" alt="" class="img-fluid"> <span>Export data into multiple
      ...
      <div class="card_box">
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12 left_card">
            <div class="Code_for_Vcard_Plus_img"> <img src="assets/images/play.png" class="img-fluid" alt=""> </div>
          </div>
          <div class="col-lg-8 col-md-8 col-sm-12 connections">
            <h3>Make instant connections with valuable clients by connecting your QR code to a digital business card.
            </h3>
            <p>Connect instantly with business possibilities.</p>
            <div class="icon"> <img src="assets/images/click.png" alt="" class="img-fluid"> <span>Instant access to your
                contact details via your QR Code.</span> </div>
            <div class="icon"> <img src="assets/images/click.png" alt="" class="img-fluid"> <span>Include your business address
                to make it even easier for clients to find you.</span> </div>
            <div class="icon"> <img src="assets/images/click.png" alt="" class="img-fluid"> <span>A simple tap and your contact
                details are in their phonebook.</span> </div>
            <div class="icon"> <img src="assets/images/click.png" alt="" class="img-fluid"> <span>Connects people with your
                social media profiles allowing them to discover more about what you can offer them.</span> </div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="footer">
    <div class="container footer_container">
      <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-12 footer_log"> <a class=" font-weight-bold" href="index.html"> <img
              class="footer_logo" src="assets/images/main-logo.svg" alt="logo" width="119"> </a>
          <p class="logo-text">QR Code Generator lets you create memorable marketing campaigns with trackable QR
            Codes—designed by you</p>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-12 services">
          <div class="footer_collapse hidden visible-md d-lg-none d-md-block" type="button" data-toggle="collapse"
            data-target="#slide6" aria-expanded="false" aria-controls="slide6">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 prices">
          <div class="footer_collapse hidden visible-md d-lg-none d-md-block" type="button" data-toggle="collapse"
            data-target="#slide7" aria-expanded="false" aria-controls="slide7">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 help">
          <div class="footer_collapse hidden visible-md d-lg-none d-md-block" type="button" data-toggle="collapse"
            data-target="#slide8" aria-expanded="false" aria-controls="slide8">
